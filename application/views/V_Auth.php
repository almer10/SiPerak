          ...
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
              <?=form_open('auth/login', array('method'=>'post'));?>
                ...
                <marquee>Selamat Datang di Dashboard SDM PT Pelabuhan Tanjung Priok</marquee>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control" placeholder="NIPP/NIP">
                </div>
                <div class="form-group">
