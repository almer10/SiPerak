...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2021 at 11:56 PM
...
(1, 'admin', 'admin@gmail.com', 'Axel reyhan', '21232f297a57a5a743894a0e4a801fc3', 'admin', '356396e51799ad57d0d0301ec6b4ec66.JPG'),
...
CREATE TABLE `tb_pegawai` (
  ...
  `jurusan_pendidikan` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  ...
  `kelas_jabatan` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `nama_jabatan` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `unit_kerja` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `tmt_capeg` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `tmt_jabatan` varchar(256) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `id_jabatan` int(255) NOT NULL,
  `id_bidang` int(255) NOT NULL,
  `agama` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `alamat` text COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `npwp` int(128) NOT NULL,
  `bpjskes` int(128) NOT NULL,
  `bpjsket` int(128) NOT NULL,
...
INSERT INTO `tb_pegawai` (`id`, `nama`, `nip`, `tempat_lahir`, `tanggal_lahir`, `umur`, `jenis_kelamin`, `pendidikan_terakhir`, `jurusan_pendidikan`, `status_perkawinan`, `status_pegawai`, `kelas_jabatan`, `nama_jabatan`, `unit_kerja`, `tmt_capeg`, `tmt_jabatan`, `id_jabatan`, `id_bidang`, `agama`, `alamat`, `npwp`, `bpjskes`, `bpjsket`, `nik`, `no_ktp`, `no_rumah`, `no_handphone`, `email`, `password`, `id_user`, `tanggal_pengangkatan`, `avatar`) VALUES
(10, 'Angga', 41551, 'Jakarta , bekasi , depok', '1989-02-09', 0, 'Laki-laki', 'S1', '', 'Belum kawin', 'Karyawan tetap', '', '', '', '', '', 3, 1, 'Islam', 'Komplek Permata Hijau No. 12', 0, 0, 0, 0, 2147483647, 12, 2147483647, 'pegawai@gmail.com', '047aeeb234644b9e2d4138ed3bc7976a', 'pegawai', '2018-07-04', '5c70d761d806feee7d0bfa3ebab20808.JPG'),
(13, 'Ronaldo', 123451, 'Bekasi', '2021-10-01', 0, 'Laki-laki', 'Diploma', '', 'Belum kawin', 'Karyawan tetap', '', '', '', '', '', 1, 1, 'Islam', 'Bekasi', 0, 0, 0, 0, 3131313, 13, 131331, 'pegawai2@gmail.com', '047aeeb234644b9e2d4138ed3bc7976a', 'pegawai2', '2021-10-02', 'e969b47a7bcdbd7b9f551e5184449c43.jpg');
